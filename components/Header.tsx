  ...
  return (
    <header className="relative p-16 text-center">
      ...
      <div className="flex space-x-2 absolute -top-5 right-5">
        <Link href="/">
          <FilePen className="w-8 h-8 lg:w-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
        <Link href="/stories">
          <BookOpen className="w-8 h-8 lg:w-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-50 cursor-pointer" />
        </Link>
      </div>
    </header>
  );
